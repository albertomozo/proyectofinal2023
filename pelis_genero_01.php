        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                foreach ($generosT as $key => $valor){
                  echo '<button class="btn btn-primary w-100" type="button" data-genero="'.$key.'" onClick="peliculasFiltarGenero('.$key.')">
                ...
                if(mysqli_num_rows($resultado)!=0){ 
                    ...
                    // OBTENCION DE GENEROS DE UNA PELI 
                        ...
                        <article id="<?php echo $fila['id'];?>" class="<?php echo $clasesGenero;?>" class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.1s">
