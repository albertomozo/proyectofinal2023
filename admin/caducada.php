...
<head>
    <?php 
     $headTitle .= " Caducada";
     $headDescription .= "Página  a la que se llega cuando no hay sesion activa";
     $headKeywords .=""; 
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                            <div class="error mx-auto" data-text="Cad">Cad</div>
                            ...
                            <a href="login.php?msg=3">&larr; Accede al login </a>
                    </div>             
                </div>
                <!-- /.container-fluid -->
